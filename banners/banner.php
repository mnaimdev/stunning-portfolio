                    ...
                    <table class="table table_striped">
                        ...
                        <?php foreach ($select_banner as $key => $banner) { ?>
                            <tr>
                                ...
                                <td><?= $banner["title"] ?></td>
                                <td><?= substr($banner["desp"], 0, 50) . "...more" ?></td>
                                <td>
                                    <a href="banner_status.php?id= <?= $banner["id"] ?>">
                                        <span class="badge text-bg-<?= ($banner["status"] == 1 ? "success" : "secondary") ?>"><?= $banner["status"] == 1 ? "Active" : "Deactive" ?></span>
                                    </a>
                                </td>
                                <td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button data-link="delete_banner.php?id= <?= $banner["id"] ?>" class="dropdown-item delete_btn">Delete</button>
                                        </div>
                                    </div>
