...
<head>
    ...
    <link rel="stylesheet" href="/stunning portfolio/dashboard_asset/vendor/chartist/css/chartist.min.css">
    <link href="/stunning portfolio/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link href="/stunning portfolio/dashboard_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/stunning portfolio/dashboard_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/stunning portfolio/dashboard_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/stunning portfolio/dashboard_asset/images/logo-text.png" alt="">
            </a>
            ...
            <div class="header-content">
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <a href="http://localhost/stunning portfolio/index.php" class="btn btn-primary" target="_blank">Visit Site</a>
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="/stunning portfolio/uploads/users/<?= $after_assoc_user["image"] ?>" width="20" alt="" />
                                    <div class="header-info">
                                        <span class="text-black">
                                            <strong>
                                                <?= $after_assoc_user["name"] ?>
                                            </strong>
                                        </span>
                                        <p class="fs-12 mb-0">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/stunning portfolio/users/profile.php" class="dropdown-item ai-icon">
                                    ...
                                    <a href="/stunning portfolio/logout.php" class="dropdown-item ai-icon">
            ...
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="flaticon-381-networking"></i>
                            <span class="nav-text">Dashboard</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/dashboard.php">Dashboard</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-user"></i>
                            <span class="nav-text">Apps</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/users/users.php">Users</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-picture-o"></i>
                            <span class="nav-text">Logo</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/logos/logo.php">Add Logo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="flaticon-381-television"></i>
                            <span class="nav-text">Banner</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/banners/banner.php">Add Banner</a></li>
                            <li><a href="/stunning portfolio/banners/banner_image.php">Add Banner Image</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-facebook"></i>
                            <span class="nav-text">Social</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/socials/social.php">Add Social Icon</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-book"></i>
                            <span class="nav-text">Education</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/educations/education.php">Add Education</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-user"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/introductions/intro.php">Add Introduction</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-building"></i>
                            <span class="nav-text">Services</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/services/service.php">Add Services</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-briefcase"></i>
                            <span class="nav-text">Works</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/works/work.php">Add Works</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-plus-square"></i>
                            <span class="nav-text">Counts</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/counts/count.php">Add Counts</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-star"></i>
                            <span class="nav-text">Testimonial</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/testimonials/testimonial.php">Add Testimonial</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-address-book"></i>
                            <span class="nav-text">Add Contact</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/contacts/contact.php">Add Contact</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-free-code-camp"></i>
                            <span class="nav-text">Add Brand</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/brands/brand.php">Add Brand</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i style="font-family: fontawesome" class="fa-comments"></i>
                            <span class="nav-text">Messages</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/stunning portfolio/messages/message.php">Add Message</a></li>
                        </ul>
                    </li>
